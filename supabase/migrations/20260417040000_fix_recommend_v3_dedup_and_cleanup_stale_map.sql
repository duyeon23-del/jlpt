-- =============================================================
-- Cleanup stale mappings + deduplicate recommendations in v3
-- =============================================================

begin;

-- 1) Remove stale single mappings
delete from public.question_skill_map qsm
...
-- 2) Remove stale passage/grammar_context mappings
delete from public.question_skill_map qsm
...
-- 3) Recreate RPC with per-question deduplication
